...
type HelloClientStreamResponse struct {
	...
	HelloList []string `protobuf:"bytes,1,rep,name=hello_list,json=helloList,proto3" json:"hello_list,omitempty"`
}
...
func (x *HelloClientStreamResponse) GetHelloList() []string {
	if x != nil {
		return x.HelloList
	}
	return nil
...
type HelloServerStreamResponse struct {
	...
	Hello string `protobuf:"bytes,1,opt,name=hello,proto3" json:"hello,omitempty"` // return all hello history
}
...
func (x *HelloServerStreamResponse) GetHello() string {
	if x != nil {
		return x.Hello
	}
	return ""
...
type HelloBidirectionalRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *HelloBidirectionalRequest) Reset() {
	*x = HelloBidirectionalRequest{}
	if protoimpl.UnsafeEnabled {
...
func (x *HelloBidirectionalRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*HelloBidirectionalRequest) ProtoMessage() {}

func (x *HelloBidirectionalRequest) ProtoReflect() protoreflect.Message {
	mi := &file_proto_hello_proto_msgTypes[6]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use HelloBidirectionalRequest.ProtoReflect.Descriptor instead.
func (*HelloBidirectionalRequest) Descriptor() ([]byte, []int) {
	return file_proto_hello_proto_rawDescGZIP(), []int{6}
}

func (x *HelloBidirectionalRequest) GetName() string {
	if x != nil {
		return x.Name
	}
	return ""
...
type HelloBidirectionalResponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *HelloBidirectionalResponse) Reset() {
	*x = HelloBidirectionalResponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *HelloBidirectionalResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*HelloBidirectionalResponse) ProtoMessage() {}

func (x *HelloBidirectionalResponse) ProtoReflect() protoreflect.Message {
	mi := &file_proto_hello_proto_msgTypes[7]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use HelloBidirectionalResponse.ProtoReflect.Descriptor instead.
func (*HelloBidirectionalResponse) Descriptor() ([]byte, []int) {
	return file_proto_hello_proto_rawDescGZIP(), []int{7}
}

func (x *HelloBidirectionalResponse) GetHello() string {
	if x != nil {
		return x.Hello
	}
	return ""
...
var file_proto_hello_proto_rawDesc = []byte{
	...
	,
	...
	0x65, 0x6c, 0x6c, 0x6f, 0x22, 0x2f, 0x0a, 0x19, 0x48, 0x65, 0x6c, 0x6c, 0x6f, 0x42, 0x69, 0x64,
	0x69, 0x72, 0x65, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x61, 0x6c, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73,
	0x74, 0x12, 0x12, 0x0a, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52,
	0x04, 0x6e, 0x61, 0x6d, 0x65, 0x22, 0x32, 0x0a, 0x1a, 0x48, 0x65, 0x6c, 0x6c, 0x6f, 0x42, 0x69,
	...
	0x28, 0x09, 0x52, 0x05, 0x68, 0x65, 0x6c, 0x6c, 0x6f, 0x32, 0xdd, 0x02, 0x0a, 0x0c, 0x48, 0x65,
	...
	0x12, 0x5a, 0x0a, 0x11, 0x48, 0x65, 0x6c, 0x6c, 0x6f, 0x43, 0x6c, 0x69, 0x65, 0x6e, 0x74, 0x53,
	0x74, 0x72, 0x65, 0x61, 0x6d, 0x12, 0x1f, 0x2e, 0x68, 0x65, 0x6c, 0x6c, 0x6f, 0x2e, 0x48, 0x65,
	0x6c, 0x6c, 0x6f, 0x43, 0x6c, 0x69, 0x65, 0x6e, 0x74, 0x53, 0x74, 0x72, 0x65, 0x61, 0x6d, 0x52,
	...
	,
...
var file_proto_hello_proto_goTypes = []interface{}{
	...
	(*HelloClientStreamRequest)(nil),   // 2: hello.HelloClientStreamRequest
	(*HelloClientStreamResponse)(nil),  // 3: hello.HelloClientStreamResponse
	(*HelloServerStreamRequest)(nil),   // 4: hello.HelloServerStreamRequest
	(*HelloServerStreamResponse)(nil),  // 5: hello.HelloServerStreamResponse
	(*HelloBidirectionalRequest)(nil),  // 6: hello.HelloBidirectionalRequest
	(*HelloBidirectionalResponse)(nil), // 7: hello.HelloBidirectionalResponse
}
var file_proto_hello_proto_depIdxs = []int32{
	0, // 0: hello.HelloService.Hello:input_type -> hello.HelloRequest
	2, // 1: hello.HelloService.HelloClientStream:input_type -> hello.HelloClientStreamRequest
	4, // 2: hello.HelloService.HelloServerStream:input_type -> hello.HelloServerStreamRequest
	6, // 3: hello.HelloService.HelloBidirectional:input_type -> hello.HelloBidirectionalRequest
	1, // 4: hello.HelloService.Hello:output_type -> hello.HelloResponse
	3, // 5: hello.HelloService.HelloClientStream:output_type -> hello.HelloClientStreamResponse
	5, // 6: hello.HelloService.HelloServerStream:output_type -> hello.HelloServerStreamResponse
	7, // 7: hello.HelloService.HelloBidirectional:output_type -> hello.HelloBidirectionalResponse
...
func file_proto_hello_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_proto_hello_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*HelloClientStreamRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_proto_hello_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*HelloClientStreamResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_proto_hello_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*HelloServerStreamRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_proto_hello_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*HelloServerStreamResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_proto_hello_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*HelloBidirectionalRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_proto_hello_proto_msgTypes[7].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*HelloBidirectionalResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
